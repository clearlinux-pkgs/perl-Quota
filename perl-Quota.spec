...
Source0  : https://cpan.metacpan.org/authors/id/T/TO/TOMZO/Quota-1.7.3.tar.gz
...
%prep
%setup -q -n Quota-1.7.3
cd %{_builddir}
tar xf %{_sourcedir}/libquota-perl_1.7.2+dfsg-1.debian.tar.xz
cd %{_builddir}/Quota-1.7.3
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Quota-1.7.3/deblicense/
